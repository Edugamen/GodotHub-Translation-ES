...
function FeaturedCard({ entry }: { entry: UpdateEntry }) {
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border border-accent-dim/50 bg-gradient-to-br from-raised via-surface to-accent-dim/10 p-6 hover:border-accent-dim/80 transition-colors"
    >
