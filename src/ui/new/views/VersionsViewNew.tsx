...
export function VersionsViewNew({
  onOpenSettings,
}: {
  onOpenSettings?: () => void
}) {
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              {filteredInstalled.map((v, i) => (
                ...
                >
                <div
                  className="flex items-center justify-between gap-3 rounded-item bg-overlay border border-outline/50 px-4 py-3.5 hover:border-accent-dim transition-colors"
                >
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          <motion.button
                            type="button"
                            whileTap={{ scale: 0.92 }}
                            onClick={() => startEditing(v.tag, v.custom_name)}
                  ...
                  <div className="flex items-stretch gap-1 shrink-0 justify-end">
                    <motion.button
                      ...
                      type="button"
                      onClick={() =>
                        openVersion(v.tag, consoleToggles[v.tag] || undefined)
                      }
                    ...
                    {v.supports_console && (
                      <motion.button
                        key={consoleToggles[v.tag] ? 'console-on' : 'console-off'}
                      ...
                      >
                        <IconTerminal
                          className={`w-4 h-4 ${consoleToggles[v.tag] ? 'text-mint' : ''}`}
                        />
                      </motion.button>
                    )}
                    <Dropdown
                      ...
                      items={[
                          ...
                          ? [
                              {
                                ...
                                icon: IconTerminal,
                                onClick: () => openVersion(v.tag, true),
                              },
                            ]
                          : []),
                        {
                        ...
                        },
                        {
                          ...
                          danger: true,
                          dividerAfter: true,
                          onClick: () => setConfirmUninstallTag(v.tag),
                        },
                      ]}
                    />
                  </div>
      ...
      <AnimatePresence>
        {confirmUninstallTag && (
          <ConfirmDialog
            ...
            description={tc('version_uninstall_desc', {
              tag: confirmUninstallTag,
            })}
