    ...
    <>
      ...
      >
        <motion.div
          ...
          className="bg-surface border border-outline/50 rounded-2xl w-full max-w-xl flex flex-col shadow-2xl shadow-black/50"
        ...
        >
          <div className="flex items-start gap-3.5 p-6 pb-4 border-b border-line">
            ...
            <button
              onClick={onClose}
              className="focus-ring cursor-pointer p-1.5 rounded-item text-muted hover:text-ink hover:bg-raised transition-colors shrink-0"
            >
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-8 gap-3">
                ...
                <button
                  ...
                  className="focus-ring cursor-pointer flex items-center gap-1.5 px-3.5 py-2 rounded-item bg-accent hover:bg-accent-bright text-xs font-medium text-white transition-colors"
                >
          ...
          <div className="flex items-center justify-between gap-3 px-6 py-4 border-t border-line">
            <div className="flex items-center gap-2">
              <button
                ...
                className="focus-ring cursor-pointer flex items-center gap-1.5 px-3.5 py-2 rounded-item border border-danger/40 text-danger hover:bg-danger/10 text-xs transition-colors"
              >
              ...
              <button
                ...
                className="focus-ring cursor-pointer flex items-center gap-1.5 px-3.5 py-2 rounded-item border border-outline/50 text-muted hover:text-ink hover:bg-raised text-xs transition-colors"
              >
            ...
            <div className="flex items-center gap-2.5">
              <button
                onClick={onClose}
                className="focus-ring cursor-pointer px-4 py-2 rounded-item border border-outline/50 text-muted hover:text-ink hover:bg-raised text-xs transition-colors"
              >
                {t('close')}
              </button>
              {allResolved && (
                <button
                  ...
                  className="focus-ring cursor-pointer flex items-center gap-1.5 px-4 py-2 rounded-item bg-mint hover:brightness-110 text-white text-xs font-medium transition-colors"
                >
